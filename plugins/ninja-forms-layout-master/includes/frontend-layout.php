...
class Bti_Layout_Master_Frontend_Layout {
	...
	function before_field( $field_id ) {
		...
		$form_data  = $form['data']['bti_layout_master'];
		...
		foreach ( $forms as $form ) {
			if ( isset( $form['data']['bti_layout_master'] ) ) {
				...
				if ( isset( $layout_master['enable_css'] ) && 1 == $layout_master['enable_css'] ) {
					...
					// Field error
					$input_error_color = isset( $lm['input_error_color'] ) ? sprintf('color: %s;', $lm['input_error_color']) : '#ff0000';
					...
					// Buttons
					$button_color              = ( isset( $lm['button_color'] ) && !empty( $lm['button_color'] ) ) ? sprintf('color: %s;', $lm['button_color']) : '';
					$button_font_size          = ( isset( $lm['button_font_size'] ) && !empty( $lm['button_font_size'] ) ) ? sprintf('font-size: %dpx;', $lm['button_font_size']) : '';
					$button_bg_color           = ( isset( $lm['button_bg_color'] ) && !empty( $lm['button_bg_color'] ) ) ? sprintf('background: %s;', $lm['button_bg_color']) : '';
					$button_border_color       = ( isset( $lm['button_border_color'] ) && !empty( $lm['button_border_color'] ) ) ? sprintf('border-color: %s;', $lm['button_border_color']) : '';
					$button_border_size        = ( isset( $lm['button_border_size'] ) && !empty( $lm['button_border_size'] ) ) ? sprintf('border-width: %dpx;', $lm['button_border_size']) : '';
					$button_border_radius      = ( isset( $lm['button_border_radius'] ) && !empty( $lm['button_border_radius'] ) ) ? sprintf('border-radius: %dpx;', $lm['button_border_radius']) : '';
					...
					// Hover Buttons
					$button_hover_color              = ( isset( $lm['button_hover_color'] ) && !empty( $lm['button_hover_color'] ) ) ? sprintf( 'color: %s;', $lm['button_hover_color'] ) : '';
					$button_hover_font_size          = ( isset( $lm['button_hover_font_size'] ) && !empty( $lm['button_hover_font_size'] ) ) ? sprintf( 'font-size: %dpx;', $lm['button_hover_font_size'] ) : '';
					$button_hover_bg_color           = ( isset( $lm['button_hover_bg_color'] ) && !empty( $lm['button_hover_bg_color'] ) ) ? sprintf( 'background: %s;', $lm['button_hover_bg_color'] ) : '';
					$button_hover_border_color       = ( isset( $lm['button_hover_border_color'] ) && !empty( $lm['button_hover_border_color'] ) ) ? sprintf( 'border-color: %s;', $lm['button_hover_border_color'] ) : '';
					$button_hover_border_size        = ( isset( $lm['button_hover_border_size'] ) && !empty( $lm['button_hover_border_size'] ) ) ? sprintf( 'border-width: %dpx;', $lm['button_hover_border_size'] ) : '';
					$button_hover_border_radius      = ( isset( $lm['button_hover_border_radius'] ) && !empty( $lm['button_hover_border_radius'] ) ) ? sprintf( 'border-radius: %dpx;', $lm['button_hover_border_radius'] ) : '';
